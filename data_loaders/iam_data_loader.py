...
class IAMDataset(Dataset):
    def __init__(self, labels, path_images, dictionary, max_len):
...
class IAMDataLoader(object):
    def __init__(self, batch_size, shuffle, labels, path_images,
                 dictionary, max_len):
        self.batch_size = batch_size
        self.shuffle = shuffle
        self.dataset = IAMDataset(labels, path_images,
                                  dictionary, max_len)
